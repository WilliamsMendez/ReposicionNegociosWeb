<h1>{{modedsc}}</h1>
<section class="row">
    <form action="index.php?page=Mnt_Car&mode={{mode}}&registro_id={{registro_id}}" method="POST" class="col-6 col-3offset">
        <section class="row">
        ...
        <section class="row">
            ...
            <input type="text" {{readonly}} name="placa_carro" value="{{placa_carro}}" maxlength="45" placeholder="Placa de Car"/>
